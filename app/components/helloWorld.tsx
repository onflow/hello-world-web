...
export default function HelloWorld() {
    ...
    return (
        <div className="flex flex-grow flex-col w-[200px] items-center text-center">
           <span className="m-5 w-1/2 bold text-gray-700 px-4">Simple web application to demonstrate how to interact with a HelloWorld contract on testnet using FLIX.</span> 
           <span className="flex text-lg">Read HelloWorld greeting</span> 
            ...
            <button className="m-1 w-1/2 bg-blue-500 text-white p-1 rounded" onClick={() => clearDisplay()}>Clear Display</button>
            ...
            <button className="m-1 w-1/2 bg-blue-500 text-white p-1 rounded" onClick={() => updateMyGreeting({ greeting: ALT_GREETING})}>Change Greeting</button>
            <button className="m-1 w-1/2 bg-blue-500 text-white p-1 rounded" onClick={() => updateMyGreeting({ greeting: DEFAULT_GREETING})}>Reset Greeting</button>
